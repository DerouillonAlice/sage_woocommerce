...
?>
<header class="woocommerce-products-header mb-8  py-12">
  <div class="container mx-auto px-4 lg:px-6">
    ...
    ?>
      <h1 class="woocommerce-products-header__title page-title text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-center">
