<header class="bg-white">
  <div class="container mx-auto px-6">
    <div class="grid grid-cols-1 lg:grid-cols-3 items-center gap-4 h-auto lg:h-16">
      {{-- Logo à gauche --}}
      ...
      <div class="order-last lg:order-none flex justify-center">
        <form role="search" method="get" class="w-full max-w-md lg:max-w-2xl" action="{{ home_url('/') }}">
